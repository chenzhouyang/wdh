...
public class SearchGoodsListAdapter extends BaseAdapter {
    ...
    public SearchGoodsListAdapter(Context context, ArrayList<GoodsListEntity.GoodsListBean> arrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_search_goods_list,null);
        ...
        GlideImage.loadImage(context,holder.img_goods,goodsList.originalImg.toString(),R.mipmap.img_error);
        ...
        holder.img_show.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (arrayList.get(position).goodsId != null) {
                    Intent intent = new Intent(context, BuyersShowListActivity.class);
                    intent.putExtra("goodsId", arrayList.get(position).goodsId);
