...
public class ProductAdapter extends BaseAdapter {
    ...
    private ChooseDishActivity activity;
    private SparseArray<GoodsBean.DataBean.LocalLifesBean> dataList;
    public ProductAdapter(ChooseDishActivity activity, GoodsAdapter goodsAdapter, SparseArray<GoodsBean.DataBean.LocalLifesBean> dataList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            StringUtils.filtNull(viewholder.tv_name,dataList.valueAt(position).lifeName);//商品名称
            StringUtils.filtNull(viewholder.tv_price,"￥"+dataList.valueAt(position).teamBuyPrice);//商品价格
