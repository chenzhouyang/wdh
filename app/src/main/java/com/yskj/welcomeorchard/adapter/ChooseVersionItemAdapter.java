...
/**
 * 创建日期 2017/5/15on 11:05.
 * 描述：
 * 作者：姜贺YSKJ-JH
 */

public class ChooseVersionItemAdapter extends BaseAdapter{
    private ArrayList<ChooseVersionItemEntity.AdrTlistBean> arrayList;
    private Context context;

    public ChooseVersionItemAdapter(ArrayList<ChooseVersionItemEntity.AdrTlistBean> arrayList, Context context) {
