 ...
 */
public class AlbumGridViewAdapter extends android.widget.BaseAdapter {
    /**
     ...
     */
        ...
        NBitmapCache.ImageCallback callback = new NBitmapCache.ImageCallback() {
            @Override
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.item_camera_select_imageview,null);
