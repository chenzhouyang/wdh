...
import com.yskj.welcomeorchard.entity.CityTestEntity;
import com.yskj.welcomeorchard.utils.AppJsonFileReader;

import java.lang.reflect.Type;
import java.util.ArrayList;

import static com.yskj.welcomeorchard.R.id.img_back;
...
public class CitySeletActivity extends BaseActivity {
    ...
    class DataThread extends Thread {
        @Override
        public void run() {
            String jsonStr = AppJsonFileReader.getJson(CitySeletActivity.this, fileName);
            Gson gson = new Gson();
