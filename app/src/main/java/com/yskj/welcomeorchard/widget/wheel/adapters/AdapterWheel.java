...
package com.yskj.welcomeorchard.widget.wheel.adapters;


import android.content.Context;

import com.yskj.welcomeorchard.entity.CityEntity;
import com.yskj.welcomeorchard.widget.wheel.views.WheelAdapter;
...
public class AdapterWheel extends AbstractWheelTextAdapter {
    ...
    @Override
    protected List<CityEntity> getItemObject(int index) {
        return null;
    }
