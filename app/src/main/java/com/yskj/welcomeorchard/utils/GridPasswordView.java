...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textColor = ta.getColorStateList(R.styleable.auto3d_textColor);
        if (textColor == null)
            textColor = ColorStateList.valueOf(getResources().getColor(R.color.gray));
        int textSize = ta.getDimensionPixelSize(R.styleable.auto3d_textSize, -1);
        if (textSize != -1) {
        ...
        gridColor = ta.getColor(R.styleable.gridPasswordView_gridColor, getResources().getColor(R.color.white));
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.orchard_gridpasswordview, this);
