...
public class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                resources.getDrawable(R.drawable.v2_camera_crop_width);
        mResizeDrawableHeight =
                resources.getDrawable(R.drawable.v2_camera_crop_height);
        mResizeDrawableDiagonal =
                resources.getDrawable(R.drawable.v2_indicator_autocrop);
    }
